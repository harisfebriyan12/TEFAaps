      ...
      >
        ...
        <Animated.View entering={FadeIn.duration(800)}>
          ...
          >
            ...
            {/* Search Bar */}
            <Animated.View entering={SlideInRight.delay(250).duration(500)}>
              <TouchableOpacity 
                style={styles.searchBar}
                onPress={() => router.push('/search')}
              >
                <Feather name="search" size={18} color="#6B7280" />
                <Text style={styles.searchInput}>Cari layanan joki...</Text>
              </TouchableOpacity>
            </Animated.View>
          </LinearGradient>
        </Animated.View>
        ...
        {/* Service Categories */}
        <Animated.View entering={FadeInDown.duration(600).delay(150)} style={styles.categorySection}>
          <ScrollView 
            horizontal 
          ...
          >
            {serviceCategories.map((category, index) => (
              <Animated.View 
                key={category.id}
                entering={SlideInRight.delay(100 + index * 50).duration(400)}
              >
                <TouchableOpacity 
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <ScrollView style={styles.formContainer}>
              <Text style={styles.formLabel}>Username Game/Akun *</Text>
              <TextInput
